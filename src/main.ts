...
import { Client, Events, GatewayIntentBits, REST, Routes, SlashCommandBuilder } from "npm:discord.js@14.14";
import { getDiscordToken, getClientId } from "./utils/mod.ts";
...
async function main(): Promise<void> {
	...
	await rest.put(Routes.applicationGuildCommands(clientId, "850778288473243648"), {body: commandsRegister});
